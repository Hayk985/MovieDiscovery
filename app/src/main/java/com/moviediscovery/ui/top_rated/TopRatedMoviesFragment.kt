package com.moviediscovery.ui.top_rated
...
class TopRatedMoviesFragment : Fragment() {
    ...
    private val topRatedMoviesViewModel by viewModels<TopRatedMoviesViewModel>()
    ...
    override fun onCreateView(
        ...
        val rvEndReachedListener = object : RecyclerViewEndReachedListener(
            ...
            override fun onEndReached() {
                topRatedMoviesViewModel.loadMore()
            }
        }
        ...
        binding.viewSwipeRefresh.setOnRefreshListener {
            topRatedMoviesViewModel.getTopRatedMovies(isRefreshing = true)
        }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        topRatedMoviesViewModel.uiStateLiveData.observe(viewLifecycleOwner) { state ->
    ...
    private fun displayError(errorUIState: ErrorUIState, movieList: List<Movie>?) {
        ...
        when (errorUIState) {
            ...
            is ErrorUIState.ToastError -> {
                if (!topRatedMoviesViewModel.isToastErrorShown())
